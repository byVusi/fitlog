 ...
 */
function createExercise(name, image, description, tags = []) {
	return {
		name,
		image,
		isReadOnly: false,
...
const GYM_PROGRAM = {
	monday: {
		...
		tricepDips: createExercise("Tricep Dips", "./assets/media/images/tricep-dips-sq.jpg", "3 sets to failure", [
			TAGS.TRICEPS,
			TAGS.PUSH,
		]),
		plank: createExercise("Plank", "./assets/media/images/plank-sq.jpg", "3 sets x 30-60 seconds", [TAGS.CORE]),
	},
	tuesday: {
		...
		deadlifts: createExercise("Deadlifts", "./assets/media/images/deadlifts-sq.jpg", "3 sets x 10-12 reps", [
			TAGS.LEGS,
			TAGS.GLUTES,
			TAGS.BARBELL,
			TAGS.PULL,
		...
		legPress: createExercise("Leg Press", "./assets/media/images/legpress-sq.jpg", "3 sets x 10-12 reps", [
			TAGS.LEGS,
			TAGS.GLUTES,
			TAGS.MACHINE,
			TAGS.PUSH,
		]),
		calfRaises: createExercise("Calf Raises", "./assets/media/images/calf-raises-sq.jpg", "4 sets x 15-20 reps", [
			TAGS.LEGS,
			TAGS.CALVES,
			TAGS.MACHINE,
			TAGS.PUSH,
	...
	thursday: {
		...
		warmUp: createWarmUp(),
		pullUps: createExercise("Pull Ups", "./assets/media/images/pullups-sq.jpeg", "3 sets x 10-12 reps", [
			TAGS.BACK,
			TAGS.LATTS,
			TAGS.PULL,
		]),
		dumbbellRows: createExercise("Dumbbell Rows", "./assets/media/images/dumbbell-rows-sq.jpg", "3 sets x 8-10 reps", [
			TAGS.BACK,
			TAGS.LATTS,
			TAGS.DUMBBELL,
			TAGS.BENCH,
		...
		facePulls: createExercise("Face Pulls", "./assets/media/images/face-pulls-sq.jpg", "3 sets x 10-12 reps", [
			TAGS.BACK,
			TAGS.MACHINE,
			TAGS.CABLES,
			TAGS.PULL,
	...
	friday: {
		...
		lightCardio: createWarmUp("30-40 minutes steady-state cardio (e.g., treadmill incline walk or cycling)", [
			TAGS.CARDIO,
		]),
		legRaises: createExercise("Leg Raises", "./assets/media/images/leg-raises-sq.jpg", "3 sets x 12-15 reps", [
			TAGS.CORE,
		]),
